...
# ################################
# # 运行回测，生成成交图
# dbt = DrawBacktestingTrade('drawtrade_backtesting.ini', startTradingDay=arrow.get('2019-01-14 00:00:00+08').datetime)
...
# dsim = DrawTrade('drawtrade_sim.ini', startTradingDay)
# dsim.loadTrade()
# dsim.filterTrade()
# dsim.loadBar()
# dsim.draw()
